  ...
  return (
    <section className="md:h-full md:overflow-y-auto flex-1 flex flex-col p-4 md:p-6 gap-6 mb-15 md:pb-12 bg-gray-50/30">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-5 md:p-6 shadow-sm flex flex-col gap-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-5 gap-x-8">
          <div>
            ...
            <p className="text-medium font-bold text-gray-900 leading-relaxed">
          ...
          <div>
            ...
            <p className="text-medium font-medium text-gray-900">
              {submissionDetails.manuscriptId}
            </p>
          </div>
          <div>
            <p className="text-sm font-semibold text-gray-400 uppercase tracking-wider mb-1">
          ...
          <div>
            ...
            <p className="text-medium font-medium text-gray-800">
              {submissionDetails.academicunit}
            </p>
          </div>
          <div>
            <p className="text-sm font-semibold text-gray-400 uppercase tracking-wider mb-1">
            ...
            <p className="text-medium font-medium text-blue-600 break-all">
          ...
          <div className="sm:col-span-1 lg:col-span-2 flex flex-col sm:flex-row sm:items-center justify-between gap-4 mt-2 sm:mt-0 p-3 bg-gray-50 rounded-lg border border-gray-100">
            <div>
              ...
              <p className="text-medium font-mono font-medium text-gray-700 break-all">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-5 md:p-6 shadow-sm flex flex-col gap-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-5 gap-x-8">
          <div>
            <p className="text-sm font-semibold text-gray-400 uppercase tracking-wider mb-1.5">
              Assessment Status
            </p>
            <span
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-medium font-bold text-gray-900">
              {assessmentDetails?.assessedby || "N/A"}
            </p>
          </div>
        </div>
      </div>
